    ...
    namespace GPMS.Controllers
    {
        ...
        public async Task<IActionResult> Create(int? moduleId)
        {
            ...
            // ✅ Load modules (empty initially OR filtered)
            ViewBag.Modules = moduleId.HasValue
        ...
        public async Task<IActionResult> Create(TaskModel task)
        {
            ...
            var projectId = await _context.Modules
                .Where(m => m.ModuleId == task.ModuleId)
            ...
            // 🔥 FIX: reload BOTH dropdowns properly
            ...
            ViewBag.Modules = await _context.Modules
                .Where(m => m.ModuleId == task.ModuleId) // optional filter
                .Select(m => new SelectListItem
                {
                    Value = m.ModuleId.ToString(),
                    Text = m.ModuleName
